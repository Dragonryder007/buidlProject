                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    <div className="md:col-span-2">
                        ...
                        <div className="flex gap-6">
                            <a href="https://twitter.com/buidl3" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all">
                            ...
                            <a href="https://github.com/drDreCypherpunk/buidl3" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all">
                                <Github className="w-5 h-5" />
                            </a>
                            <a href="mailto:partners@buidl3.xyz" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all">
